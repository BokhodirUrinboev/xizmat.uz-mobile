...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "additional_names":
            MessageLookupByLibrary.simpleMessage("Дополнительные имена"),
        "address_data": MessageLookupByLibrary.simpleMessage("Адресные данные"),
        "application_form":
        ...
        "s_o_optional":
            MessageLookupByLibrary.simpleMessage("с/о (опционально)"),
        "street_and_hause": MessageLookupByLibrary.simpleMessage(
            "2-я строка - улица и дом (опционально)"),
        "street_and_number":
            MessageLookupByLibrary.simpleMessage("Улица и номер"),
